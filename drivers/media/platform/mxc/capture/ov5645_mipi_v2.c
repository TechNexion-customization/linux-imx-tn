...
static struct reg_value ov5645_init_setting_30fps_VGA[] = {
	...
	{0x5000, 0xa7, 0, 0}, {0x5001, 0x83, 0, 0}, {0x501d, 0x00, 0, 0},
	{0x501f, 0x00, 0, 0}, {0x503d, 0x00, 0, 0}, {0x505c, 0x30, 0, 0},
	{0x5181, 0x59, 0, 0}, {0x5183, 0x00, 0, 0}, {0x5191, 0xf0, 0, 0},
	{0x5192, 0x03, 0, 0}, {0x5684, 0x10, 0, 0}, {0x5685, 0xa0, 0, 0},
	{0x5686, 0x0c, 0, 0}, {0x5687, 0x78, 0, 0}, {0x5a00, 0x08, 0, 0},
	{0x5a21, 0x00, 0, 0}, {0x5a24, 0x00, 0, 0}, {0x3008, 0x02, 0, 0},
	{0x3503, 0x00, 0, 0}, {0x5180, 0xff, 0, 0}, {0x5181, 0xf2, 0, 0},
	{0x5182, 0x00, 0, 0}, {0x5183, 0x14, 0, 0}, {0x5184, 0x25, 0, 0},
	{0x5185, 0x24, 0, 0}, {0x5186, 0x09, 0, 0}, {0x5187, 0x09, 0, 0},
	{0x5188, 0x0a, 0, 0}, {0x5189, 0x75, 0, 0}, {0x518a, 0x52, 0, 0},
	{0x518b, 0xea, 0, 0}, {0x518c, 0xa8, 0, 0}, {0x518d, 0x42, 0, 0},
	{0x518e, 0x38, 0, 0}, {0x518f, 0x56, 0, 0}, {0x5190, 0x42, 0, 0},
	...
	{0x5382, 0x5b, 0, 0}, {0x5383, 0x08, 0, 0}, {0x5384, 0x0b, 0, 0},
	{0x5385, 0x84, 0, 0}, {0x5386, 0x8f, 0, 0}, {0x5387, 0x82, 0, 0},
	{0x5388, 0x71, 0, 0}, {0x5389, 0x11, 0, 0}, {0x538a, 0x01, 0, 0},
	...
	{0x530c, 0x06, 0, 0}, {0x5480, 0x01, 0, 0}, {0x5481, 0x0e, 0, 0},
	{0x5482, 0x18, 0, 0}, {0x5483, 0x2b, 0, 0}, {0x5484, 0x52, 0, 0},
	...
	{0x5580, 0x02, 0, 0}, {0x5583, 0x40, 0, 0}, {0x5584, 0x30, 0, 0},
	{0x5589, 0x10, 0, 0}, {0x558a, 0x00, 0, 0}, {0x558b, 0xf8, 0, 0},
	{0x5800, 0x3f, 0, 0}, {0x5801, 0x16, 0, 0}, {0x5802, 0x0e, 0, 0},
	{0x5803, 0x0d, 0, 0}, {0x5804, 0x17, 0, 0}, {0x5805, 0x3f, 0, 0},
	{0x5806, 0x0b, 0, 0}, {0x5807, 0x06, 0, 0}, {0x5808, 0x04, 0, 0},
	{0x5809, 0x04, 0, 0}, {0x580a, 0x06, 0, 0}, {0x580b, 0x0b, 0, 0},
	{0x580c, 0x09, 0, 0}, {0x580d, 0x03, 0, 0}, {0x580e, 0x00, 0, 0},
	{0x580f, 0x00, 0, 0}, {0x5810, 0x03, 0, 0}, {0x5811, 0x08, 0, 0},
	{0x5812, 0x0a, 0, 0}, {0x5813, 0x03, 0, 0}, {0x5814, 0x00, 0, 0},
	{0x5815, 0x00, 0, 0}, {0x5816, 0x04, 0, 0}, {0x5817, 0x09, 0, 0},
	{0x5818, 0x0f, 0, 0}, {0x5819, 0x08, 0, 0}, {0x581a, 0x06, 0, 0},
	{0x581b, 0x06, 0, 0}, {0x581c, 0x08, 0, 0}, {0x581d, 0x0c, 0, 0},
	{0x581e, 0x3f, 0, 0}, {0x581f, 0x1e, 0, 0}, {0x5820, 0x12, 0, 0},
	{0x5821, 0x13, 0, 0}, {0x5822, 0x21, 0, 0}, {0x5823, 0x3f, 0, 0},
	{0x5824, 0x68, 0, 0}, {0x5825, 0x28, 0, 0}, {0x5826, 0x2c, 0, 0},
	{0x5827, 0x28, 0, 0}, {0x5828, 0x08, 0, 0}, {0x5829, 0x48, 0, 0},
	{0x582a, 0x64, 0, 0}, {0x582b, 0x62, 0, 0}, {0x582c, 0x64, 0, 0},
	{0x582d, 0x28, 0, 0}, {0x582e, 0x46, 0, 0}, {0x582f, 0x62, 0, 0},
	{0x5830, 0x60, 0, 0}, {0x5831, 0x62, 0, 0}, {0x5832, 0x26, 0, 0},
	{0x5833, 0x48, 0, 0}, {0x5834, 0x66, 0, 0}, {0x5835, 0x44, 0, 0},
	{0x5836, 0x64, 0, 0}, {0x5837, 0x28, 0, 0}, {0x5838, 0x66, 0, 0},
	{0x5839, 0x48, 0, 0}, {0x583a, 0x2c, 0, 0}, {0x583b, 0x28, 0, 0},
	{0x583c, 0x26, 0, 0}, {0x583d, 0xae, 0, 0}, {0x5025, 0x00, 0, 0},
