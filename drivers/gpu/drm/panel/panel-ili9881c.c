...
//#define   PCLOCK          85000
	/*
static const struct display_timing g3lcd_default_timing = {
...
#if 1
#define   PCLOCK          75000// 65250 // 80000
#define   LCD_VBPD        30
#define   LCD_VFPD        20
#define   LCD_VSPW        2
#define   LCD_HBPD        100
...
#if 0
    /* And reset it */
    /*gpiod_set_value*/gpio_set_value(ctx->rst_gpio, 0);
    msleep(120);

    /*gpio_set_value_cansleep*//*gpiod_set_value*/gpio_set_value(ctx->rst_gpio, 1);
    msleep(120);
#else
	msleep(5);
	gpio_set_value(ctx->rst_gpio, 1);
	usleep_range(5, 10);
	/* tREST short than 5us  */
	gpio_set_value(ctx->rst_gpio, 0);
	for(i =0; i < 50/*10*/; i++);
	gpio_set_value(ctx->rst_gpio, 1);
...
static int ili9881c_disable(struct drm_panel *panel)
{
    ...
    ret = /*mipi_dsi_dcs_enter_sleep_mode*/mipi_dsi_dcs_set_display_off(ctx->dsi);
    if (ret < 0) {
...
static const struct drm_display_mode bananapi_default_mode = {
  #if 1
	.clock		= /*76500*//*81000*/75000,
	.vrefresh	= 60,
	.hdisplay	= 720,
	.hsync_start	= 720 + /*34*/13,
	.hsync_end	= 720 + /*34*/13 + 150,
	.htotal	= 720 + /*34*/13 + 150 + /*100*/70,
	.vdisplay	= 1280,
	.vsync_start	= 1280 + 2,
	.vsync_end	= 1280 + 2 + 30,
	.vtotal	= 1280 + 2 + 30 + 20,
...
static int ili9881c_dsi_probe(struct mipi_dsi_device *dsi)
{
    ...
    int ret;
	int lanes = 4;
	printk("liutest ili9881c_dsi_probe\n");
    ...
    //ctx->rst_gpio = devm_gpiod_get(&dsi->dev, "reset-gpio", GPIOD_OUT_HIGH);
    if (IS_ERR(ctx->rst_gpio)) {
		printk("liutest devm_gpiod_get reset failed!!!\n");
        ctx->rst_gpio = NULL;
	}
    else {
		printk("liutest devm_gpiod_get reset to low\n");
