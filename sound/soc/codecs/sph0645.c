/*
 * I2S MEMS microphone driver for Knowles SPH0645LM4H-B
 *
 * - Non configurable.
...
#define SPH0645_RATE_MIN 32000  /* Hz, from data sheet */
#define SPH0645_RATE_MAX 64000  /* Hz, from data sheet */

#define SPH0645_FORMATS (SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32)
...
MODULE_AUTHOR("Ray Chang <ray.chang@technexion.com>");
